    ...
    server <- function(input, output, session) {
      ...
      shiny::observeEvent(input$migrate, {
        shiny::withProgress({
          ...
          # these attributes will be copied to the new project
          ...
          # overwrite attributes to ensure attributes are identical
          shiny::setProgress(0.10, "Importing attributes to destination...")
          ...
          shiny::setProgress(0.15, "Reading Project ID from destination...")
